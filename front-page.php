...
<header class="hero" id="accueil">
  <div class="hero-image" style="background-image:url('<?php echo esc_url( $tpl . '/assets/hero.jpg' ); ?>');"></div>
  ...
  <div class="hero-content">
    ...
    <div class="hero-actions">
      <a href="#contact" class="btn btn-primary"><?php echo esc_html( $hero_cta1 ); ?>
      ...
      <a href="#processus" class="btn btn-ghost"><?php echo esc_html( $hero_cta2 ); ?></a>
    </div>
  </div>
  ...
  <div class="hero-brand-strip">
    <div class="brand-strip-items">
      ...
      <span>• Financement partenaire</span>
  ...
  <div class="container">
    <div class="intro-split">
      <div class="intro-text reveal">
        ...
        <h2>Votre <em>mandataire dédié</em>, de la mise en vente à la remise des clés.</h2>
        <p>Autoswitch est une agence automobile pensée comme un service : vous nous confiez votre voiture, nous en tirons le meilleur. Évaluation, mise en valeur, diffusion, négociation, démarches administratives, financement — chaque étape est prise en charge par un expert unique.</p>
        <p>Plus de perte de temps, plus de négociateurs douteux, plus de paperasse : juste une vente sereine, rapide et au juste prix.</p>
        <div class="stats">
          <div class="stat-item">
      ...
      <div class="intro-image reveal">
        <img src="<?php echo esc_url( $tpl . '/assets/car-01.jpg' ); ?>" alt="Véhicule confié à Autoswitch" loading="lazy"/>
        <div class="intro-image-label">
          <strong>Une voiture mérite son acheteur.</strong>
  ...
  <div class="container">
    <div class="services-head">
      <div class="reveal">
        ...
        <h2 class="section-title">Un service <em>complet</em>, pas un simple dépôt-vente.</h2>
      </div>
      <p class="reveal">Autoswitch couvre l'intégralité de la chaîne de valeur d'une vente automobile. Six piliers, un seul interlocuteur, zéro contrainte pour vous.</p>
    </div>
    ...
    <div class="services-grid">
      ...
      foreach ( $services as $s ) : ?>
        <div class="service">
          <span class="service-num"><?php echo esc_html( $s[0] ); ?></span>
...
<section class="section section--dark" id="processus">
  <div class="container">
    <div class="process-head reveal">
      ...
      <h2 class="section-title">De votre appel à <em>la remise des clés.</em></h2>
      <p>Une méthodologie claire, éprouvée, respectueuse de votre temps. Vous suivez chaque étape, sans jamais y passer les vôtres.</p>
    </div>
    <div class="steps">
      <?php
      $steps = array(
  ...
  <div class="container">
    <div class="feature-row">
      <div class="feature-img-wrap reveal">
        <img src="<?php echo esc_url( $tpl . '/assets/feature.jpg' ); ?>" alt="Véhicule mis en valeur par Autoswitch" loading="lazy"/>
        <div class="feature-sticker">
          <strong>+8%</strong>
          Prix moyen vs vente solo
        </div>
      </div>
      <div class="feature-body reveal">
        <div class="eyebrow">Pourquoi Autoswitch</div>
        <h2>Un niveau de service que vous ne trouverez <em>pas ailleurs.</em></h2>
        <ul class="feature-list">
          <li>
            <span class="feat-ico">i.</span>
            <div>
              <div class="feat-title">Transparence radicale</div>
              <div class="feat-desc">Honoraires affichés, reporting régulier, toutes les offres qui arrivent vous sont transmises. Aucun angle mort.</div>
            </div>
          </li>
          <li>
            <span class="feat-ico">ii.</span>
            <div>
              <div class="feat-title">Interlocuteur dédié</div>
              <div class="feat-desc">Pas de plateforme, pas de centre d'appel : un expert vous accompagne du premier message au dernier coup de tampon.</div>
            </div>
          </li>
          <li>
            <span class="feat-ico">iii.</span>
            <div>
              <div class="feat-title">Réseau qualifié</div>
              <div class="feat-desc">Accès à des acheteurs sérieux, pré-qualifiés, et à un réseau de professionnels du secteur qui ouvre des circuits fermés au grand public.</div>
            </div>
          </li>
          <li>
            <span class="feat-ico">iv.</span>
            <div>
              <div class="feat-title">Zéro contrainte</div>
              <div class="feat-desc">Vous continuez à utiliser votre voiture. Les visites s'organisent quand ça vous arrange. Tout le reste, c'est nous.</div>
            </div>
          </li>
        </ul>
        <a href="#contact" class="btn btn-dark">Parler à un expert →</a>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    <div class="gallery-head reveal">
      <div>
        ...
        <h2 class="section-title">Quelques-uns des véhicules<br/>confiés à <em>Autoswitch.</em></h2>
      </div>
      <span class="mono-tag">Sélection récente — 2025</span>
    </div>
  </div>
  <div class="container">
    <div class="gallery-scroll">
      ...
      foreach ( $gallery as $g ) : ?>
        <div class="gallery-item">
          <div class="gallery-img"><img src="<?php echo esc_url( $tpl . '/assets/' . $g[0] ); ?>" alt="<?php echo esc_attr( $g[1] ); ?>" loading="lazy"/></div>
          <div class="gallery-caption"><strong><?php echo esc_html( $g[1] ); ?></strong><span><?php echo esc_html( $g[2] ); ?></span></div>
        </div>
      <?php endforeach; ?>
    </div>
  </div>
...
<section class="section">
  <div class="container">
    <div class="reveal" style="text-align:center;">
      <div class="eyebrow" style="justify-content:center;">Avis clients</div>
      <h2 class="section-title">Ils ont vendu <em>avec nous.</em></h2>
    </div>
    <div class="t-grid">
      <?php
      $tests = array(
      ...
      foreach ( $tests as $t ) : ?>
        <div class="t-card reveal">
          ...
          <div class="t-author">
            <div class="t-avatar"><?php echo esc_html( $t[1] ); ?></div>
            <div>
              <div class="t-name"><?php echo esc_html( $t[2] ); ?></div>
              <div class="t-detail"><?php echo esc_html( $t[3] ); ?></div>
            </div>
          </div>
        </div>
      <?php endforeach; ?>
...
<section class="section section--tight section--alt" id="faq">
  <div class="container">
    <div class="reveal" style="text-align:center;">
      ...
      <h2 class="section-title">Tout ce qu'il faut savoir<br/><em>avant de nous confier votre voiture.</em></h2>
    </div>
    <div class="faq-wrap reveal">
      ...
      foreach ( $faqs as $f ) : ?>
        <div class="faq-item">
          <button class="faq-q"><?php echo esc_html( $f[0] ); ?><span class="faq-plus"></span></button>
  ...
  <div class="container">
    <div class="contact-grid">
      <div class="contact-left reveal">
        ...
        <h2 class="section-title">Parlons de votre voiture.<br/><em>Sans engagement.</em></h2>
        <p>Remplissez le formulaire, ou contactez-nous directement. Une réponse sous 2h en semaine, et une estimation offerte à la clé.</p>
      ...
      <div class="form-card reveal">
        ...
        <p class="form-sub">Réponse assurée sous 2h en semaine.</p>
        <?php
        // Si Contact Form 7 est installé, on peut afficher un shortcode ; sinon formulaire simple mailto
        if ( shortcode_exists( 'contact-form-7' ) && get_theme_mod( 'autoswitch_cf7_id' ) ) {
            echo do_shortcode( '[contact-form-7 id="' . esc_attr( get_theme_mod( 'autoswitch_cf7_id' ) ) . '"]' );
        } else { ?>
...
<section class="cta-band">
  <div class="container">
    <h2 class="reveal">Votre voiture mérite un <em>professionnel qui la défend.</em></h2>
    <a href="#contact" class="btn btn-dark reveal">Démarrer une estimation →</a>
  </div>
</section>
