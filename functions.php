...
function autoswitch_scripts() {
    ...
    $inline_css = '
        ...
        /* Cartes services vertes : tout en cream #E5DEC5,
           sauf chiffres stat + catégories en champagne */
        .service-card, .service-card *{color:#E5DEC5!important;}
        .service-card .service-card-title em,
        .service-card .service-card-title strong{color:#E5DEC5!important;}
        .service-card .service-card-num{color:#D4C28A!important;}
